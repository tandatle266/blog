            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="{{ route('admin.register') }}" class="register-form" id="register-form">
                            @csrf
                    ...
                    <div class="signup-image">
                        <figure><img src="{{ asset('public/ad123/login') }}/images/signup-image.jpg" alt="sing up image"></figure>
