        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    ...
                    <a href="{{ route('web.register') }}" class="signup-image-link">Create an account</a>
                </div>

                <div class="signin-form">
                    <h2 class="form-title">Sign up</h2>
                    <form method="POST" action="{{ route('web.login') }}" method="POST" class="register-form" id="login-form">
                        @csrf 
                        ...
                        <div class="form-group" style="text-align: right !important">
                            <label for="agree-term" class="label-agree-term" >
                                <a  href="{{ route('web.reset_pass') }}" class="term-service">Forgot password ??</a></label>
                        </div>                  
                    </form>
